...
public interface IWorkflowEngineService
{
    ...
    Task<ProcessStepResponse> InterveneWorkflowAsync(int goiThauId, WorkflowInterveneRequest request);
    Task<ProcessStepResponse> SkipBranchAsync(int goiThauId, SkipBranchRequest request);
