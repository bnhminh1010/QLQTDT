...
export function AddModal({ existingItems, onSave, onClose }: Props) {
  ...
  const {
    ...
    defaultValues: { id: "", hinhThuc: "", badge: BADGE_OPTIONS[0].cls },
  });

  const selectedBadge = watch("badge");
  const previewName = watch("hinhThuc").trim() || "Chỉ định thầu rút gọn";
            ...
            <input
              ...
              {...register("id", {
                ...
                validate: {
                  ...
                  duplicate: (v) =>
                    !existingItems.some(
                      (item) => normalize(item.id) === normalize(v),
            ...
            <input
              ...
              {...register("hinhThuc", {
                ...
                validate: {
                  ...
                  duplicate: (v) =>
                    !existingItems.some(
                      (item) => normalize(item.hinhThuc) === normalize(v),
